...
if( ! defined('TEST_THEME_JS') )            define('TEST_THEME_JS', get_theme_root_uri() . '/test/js/' );
...
function test_theme_scripts(){
  if (is_front_page()){
    wp_enqueue_script( 'front-page', TEST_THEME_JS . 'front-page.js', true);
  }

}

add_action( 'wp_footer', 'test_theme_scripts' );
